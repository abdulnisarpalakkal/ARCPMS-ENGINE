...
namespace ARCPMS_ENGINE.src.mrs.Manager.PalletManager.Controller
{
    interface PalletManagerService
    {
        ...
        /// <summary>
        ///  Job for getting pallet bundle from PST using LCM
        /// </summary>
        /// <param name="objPSTData"></param>
        /// <returns></returns>

        bool GetPSTByLCM(PSTData objPSTData);
        /// <summary>
        ///  Job for putting pallet bundle to PST using LCM
        /// </summary>
        /// <param name="objPSTData"></param>
        /// <returns></returns>
        bool PutPSTByLCM(PSTData objPSTData);
        /// <summary>
