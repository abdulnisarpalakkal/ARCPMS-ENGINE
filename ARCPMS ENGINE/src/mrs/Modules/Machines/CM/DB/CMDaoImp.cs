    ...
    class CMDaoImp:CMDaoService
    {
        ...
        public bool UpdateBoolValueUsingMachineCode(string machineCode, string tableField, bool dataValue)
        {
            ...
            try
            {
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    using (OracleCommand command = con.CreateCommand())
                    {
                        qry = "UPDATE L2_LCM_UCM_MASTER SET " + tableField + " = " + intDataValue
        ...
        public bool UpdateIntValueUsingMachineCode(string machineCode, string tableField, int dataValue)
        {
            ...
            try
            {
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    using (OracleCommand command = con.CreateCommand())
                    {
                        qry = "UPDATE L2_LCM_UCM_MASTER SET " + tableField + " = " + dataValue
        ...
        public bool IsCMBlockedInDB(string machineName)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    string sql = "SELECT IS_BLOCKED FROM L2_LCM_UCM_MASTER WHERE MACHINE_CODE ='" + machineName + "'";
                    command.CommandText = sql;
        ...
        public bool UpdateMachineBlockStatus(string machine_code,bool blockStatus)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    OracleCommand command = con.CreateCommand();
                    string sql = "update L2_LCM_UCM_MASTER set IS_BLOCKED ='" + (blockStatus ? 1 : 0) + "', block_q_id=0 , BLOCKED_FOR_HOME =0"
        ...
        public bool UpdateMachineBlockStatusForHome(string machine_code, bool blockStatus)
        {
            ...
            string sql = null; 
                ...
                sql = "update L2_LCM_UCM_MASTER set IS_BLOCKED='" + (blockStatus ? 1 : 0) + "' , BLOCKED_FOR_HOME =" + (blockStatus ? 1 : 0)
        ...
        public bool IsCMDisabled(string machineName)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    OracleCommand command = con.CreateCommand();
                    string sql = "SELECT STATUS FROM L2_LCM_UCM_MASTER WHERE MACHINE_CODE ='" + machineName + "'";
                    command.CommandText = sql;
                    command.CommandType = CommandType.Text;
                    bResult = Convert.ToInt32(command.ExecuteScalar());
        ...
        public bool IsCMSwitchOff(string machineName)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    OracleCommand command = con.CreateCommand();
                    string sql = "SELECT IS_SWITCH_OFF FROM L2_LCM_UCM_MASTER WHERE MACHINE_CODE ='" + machineName + "'";
                    command.CommandText = sql;
                    command.CommandType = CommandType.Text;
                    bResult = Convert.ToInt32(command.ExecuteScalar());
        ...
        public bool UpdateCMClearRequest(string machineCode,string clearMachine, int clearFlag)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    OracleCommand command = con.CreateCommand();
                    string sql = "update L2_LCM_UCM_MASTER set CROSS_REFERENCE_CLEAR ='" + clearFlag + "',COLLAPSE_MACHINE='" + clearMachine + "'"
        ...
        public bool UpdateCMClearPermission(string machineCode)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    OracleCommand command = con.CreateCommand();
                    string sql = "update L2_LCM_UCM_MASTER set CROSS_REFERENCE_CLEAR ='" + permissionFlag + "'"
                                    + " where MACHINE_CODE = '" + machineCode + "'";
                    command.CommandText = sql;
                    command.CommandType = CommandType.Text;
                    command.ExecuteNonQuery();
        ...
        public bool GetCMClearRequest(string machineCode, out string clearingMachine, out int clearFlag)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    ...
                    OracleCommand command = con.CreateCommand();
                    string sql = "SELECT CROSS_REFERENCE_CLEAR,COLLAPSE_MACHINE FROM L2_LCM_UCM_MASTER WHERE MACHINE_CODE ='" + machineCode + "'";
                    command.CommandText = sql;
        ...
        public int GetCMAisleFromDB(string machineName)
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new DBConnection().getDBConnection())
                {
                    if (con.State == ConnectionState.Closed) con.Open();
                    OracleCommand command = con.CreateCommand();
                    string sql = "SELECT CHANGED_HOME_AISLE FROM L2_LCM_UCM_MASTER WHERE MACHINE_CODE ='" + machineName + "'";
                    command.CommandText = sql;
                    command.CommandType = CommandType.Text;
        ...
        public bool GetCMRotationEnabledStatus(string machineCode,int requestType)
        {
            bool bOk = false;
            try
            {
                ...
                {
                    OracleCommand command = con.CreateCommand();
                    string sql = "SELECT config_package.is_rotation_enabled('" + machineCode + "'," + requestType + ") FROM dual";
                    command.CommandText = sql;
                    command.CommandType = CommandType.Text;
                    bResult = Convert.ToInt32(command.ExecuteScalar());
                    bOk = bResult == 1;
