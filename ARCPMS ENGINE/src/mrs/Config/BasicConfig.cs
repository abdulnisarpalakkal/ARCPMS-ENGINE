...
namespace ARCPMS_ENGINE.src.mrs.Config
{
    class BasicConfig
    {
        ...
        /// <returns></returns>
        public static string GetXmlTextOfTag(string tagName, string filePath = "eft_config\\config.xml")
        {
        ...
        /// <param name="filePath"></param>
        /// <returns></returns>
        public static void SetXmlTextOfTag(string tagName, string tagText, string filePath = "eft_config\\config.xml" )
        {
            XmlDocument xmldoc = new XmlDocument();
            XmlNodeList xmlnode;
